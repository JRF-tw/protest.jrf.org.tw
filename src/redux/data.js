...
export const answerData = [
  {
    ...
    calculate: (state) => { return ( state.d || state.g || state.h ) ? true : false; },
    key: 'criminal140'
  }, {
    answer: '刑法§153煽惑他人犯罪',
    ...
    calculate: (state) => { return ( state.m ) ? true : false; },
    key: 'criminal354'
  }, {
    ...
    calculate: (state) => { return (( state.g || state.h ) && ( state.i || state.j )) ? true : false; },
    key: 'assembly30'
  }, {
    answer: '刑法§304強制罪',
